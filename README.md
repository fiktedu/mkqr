...
Податоците за секој ентитет се комбинираат во една инстанца на обичен текст во MKQR URI формат која апликациите кои го имплементираат станрадот можат да го анализираат. MKQR URI форматот започнува со фиксен сегмент:
